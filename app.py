...
st.write("대입 공부하는 수험생분들을 위해서 만들었습니다. 제가 공부할 때 이렇게 하면 편할 것 같아서요. 검색하고 싶은 문제를 입력하고 아래의 버튼을 클릭하면 정답 확인, 유튜브 해설, PDF 검색 결과가 즉시 새 창으로 열립니다. 상처는 빛이 들어는 창. 포기하지 말고 우리 모두 힘내요.")
